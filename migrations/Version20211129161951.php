 ...
 */
final class Version20211129161951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module CHANGE modify_at modify_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module CHANGE modify_at modify_at DATETIME NOT NULL');
