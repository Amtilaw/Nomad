...
use App\Repository\NmdFermetureRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=NmdFermetureRepository::class)
 */
class NmdFermeture
{
    /**
    ...
    public function getDateEligibiKo(): ?\DateTimeInterface
    {
        return $this->dateEligibiKo;
    }

    public function setDateEligibiKo(?\DateTimeInterface $dateEligibiKo): self
    {
        $this->dateEligibiKo = $dateEligibiKo;
