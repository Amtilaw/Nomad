...
function renderQuizz() {
  ...
  <input type="checkbox" id="proposition${i}" name="proposition${i}"
         checked>
  <label for="scales">${jsonLibelle}</label>
</div>
      
      
      
      <input type=checkbox name="box" id="proposition${i}" >
      <span>${jsonLibelle}</span>
    <label for="proposition${i}" class="box label${i}">
    <div class="course">
    <span class="circle"> </span> 
    <span class="subject" id="propositionInput${i}"> ${jsonLibelle} </label>`;
